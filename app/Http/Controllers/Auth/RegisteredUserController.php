...
class RegisteredUserController extends Controller
{
  ...
  public function __construct()
    ...
    public function store(Request $request)
    {
        ...
        // Add accountant_type validation if user is registering as accountant
        if ($request->input('type') === 'accountant') {
            $validationRules['accountant_type'] = 'required|in:individual,firm';
        }
        ...
        // Determine user type
        $userType = $request->input('type', 'company');
        ...
        // Add accountant_type if registering as accountant
        if ($userType === 'accountant') {
            $userData['accountant_type'] = $request->input('accountant_type', 'individual');
        }

        $user = User::create($userData);

        // Process affiliate referral
        AffiliateService::processReferral($user->id, $request->ref_code);
        ...
        if ($settings['email_verification'] == 'on') {
            try { 
                ...
                $roleName = $userType === 'accountant' ? 'accountant' : 'company';
                $role_r = Role::findByName($roleName);
            ...
            // Save country to company settings
            DB::insert(
