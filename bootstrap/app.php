...
return Application::configure(basePath: dirname(__DIR__))
    ...
    ->withMiddleware(function (Middleware $middleware) {
        ...
        $middleware->alias([
            ...
            'saudi-only' => \App\Http\Middleware\SaudiOnly::class,
            'track.affiliate.click' => \App\Http\Middleware\TrackAffiliateClick::class,
            'accountant.access' => \App\Http\Middleware\AccountantAccess::class,
        ]);
