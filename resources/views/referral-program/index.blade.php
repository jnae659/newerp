                                ...
                                <div class="row ">
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('level1_percentage', __('Level 1 Commission (%)'), ['class' => 'form-label']) }}<x-required></x-required>
                                            {{ Form::number('level1_percentage', isset($setting) ? $setting->level1_percentage : '', ['class' => 'form-control', 'placeholder' => __('Enter Level 1 Commission Percentage'), 'required' => 'required']) }}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('level2_percentage', __('Level 2 Commission (%)'), ['class' => 'form-label']) }}<x-required></x-required>
                                            {{ Form::number('level2_percentage', isset($setting) ? $setting->level2_percentage : '', ['class' => 'form-control', 'placeholder' => __('Enter Level 2 Commission Percentage'), 'required' => 'required']) }}
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            {{ Form::label('min_payout', __('Minimum Payout Amount'), ['class' => 'form-label']) }}<x-required></x-required>
                                            <div class="input-group">
                                                <span class="input-group-prepend"><span
                                                    class="input-group-text">{{ $currency }}</span></span>
                                            {{ Form::number('min_payout', isset($setting) ? $setting->min_payout : '', ['class' => 'form-control', 'placeholder' => __('Enter Minimum Payout'), 'required' => 'required']) }}
                                        </div>
                                        </div>
                                    </div>
