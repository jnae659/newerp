...
// Include ZATCA routes for Saudi Arabia
...
Route::middleware(['auth'])->group(function () {
    Route::get('/accountant-marketplace', [App\Http\Controllers\AccountantMarketplaceController::class, 'index'])->name('accountant.marketplace');
    Route::get('/accountant-marketplace/{id}', [App\Http\Controllers\AccountantMarketplaceController::class, 'show'])->name('accountant.marketplace.show');
    Route::post('/accountant-marketplace/{id}/request', [App\Http\Controllers\AccountantMarketplaceController::class, 'requestService'])->name('accountant.marketplace.request');
    Route::post('/accountant-marketplace/{accountant_id}/request-service/{service_id}', [App\Http\Controllers\AccountantMarketplaceController::class, 'requestSpecificService'])->name('accountant.marketplace.request.service');
});

// Accountant Service Management Routes
Route::middleware(['auth'])->group(function () {
    Route::get('/accountant/services', [App\Http\Controllers\AccountantMarketplaceController::class, 'accountantServices'])->name('accountant.services.index');
    Route::get('/accountant/services/create', [App\Http\Controllers\AccountantMarketplaceController::class, 'createService'])->name('accountant.services.create');
    Route::post('/accountant/services', [App\Http\Controllers\AccountantMarketplaceController::class, 'storeService'])->name('accountant.services.store');
    Route::get('/accountant/services/{id}/edit', [App\Http\Controllers\AccountantMarketplaceController::class, 'editService'])->name('accountant.services.edit');
    Route::put('/accountant/services/{id}', [App\Http\Controllers\AccountantMarketplaceController::class, 'updateService'])->name('accountant.services.update');
    Route::delete('/accountant/services/{id}', [App\Http\Controllers\AccountantMarketplaceController::class, 'deleteService'])->name('accountant.services.destroy');
});

// Accountant Invitation Routes
Route::middleware(['auth'])->group(function () {
    // Company routes
    Route::resource('accountant-invitations', App\Http\Controllers\AccountantInvitationController::class)->except(['show']);
    Route::post('accountant-invitations/{id}/cancel', [App\Http\Controllers\AccountantInvitationController::class, 'cancel'])->name('accountant-invitations.cancel');
    Route::post('accountant-invitations/{id}/remove', [App\Http\Controllers\AccountantInvitationController::class, 'remove'])->name('accountant-invitations.remove');
    Route::post('accountant-invitations/{id}/update-permissions', [App\Http\Controllers\AccountantInvitationController::class, 'updatePermissions'])->name('accountant-invitations.update-permissions');

    // Accountant routes
    Route::get('accountant-invitations/pending', [App\Http\Controllers\AccountantInvitationController::class, 'pending'])->name('accountant-invitations.pending');
    Route::get('accountant/clients', [App\Http\Controllers\AccountantInvitationController::class, 'clients'])->name('accountant.clients');
    Route::post('accountant-invitations/{id}/accept', [App\Http\Controllers\AccountantInvitationController::class, 'accept'])->name('accountant-invitations.accept');
    Route::post('accountant-invitations/{id}/reject', [App\Http\Controllers\AccountantInvitationController::class, 'reject'])->name('accountant-invitations.reject');
});

    // Accountant Business Profile Route
    Route::middleware(['auth'])->group(function () {
        Route::get('accountant/business-profile', [App\Http\Controllers\AccountantMarketplaceController::class, 'businessProfile'])->name('accountant.business-profile');
        Route::match(['post', 'put'], 'accountant/business-profile', [App\Http\Controllers\AccountantMarketplaceController::class, 'updateBusinessProfile'])->name('accountant.business-profile.update');
    });

    // Notification Routes
    Route::post('mark-notification-read', [App\Http\Controllers\UserController::class, 'markNotificationRead'])->name('mark.notification.read');
