...
class ChatifyMessenger
{
    ...
    /**
     * Trigger an event using Laravel Broadcasting
     *
    ...
    {
        // Use Laravel broadcasting instead of direct Pusher calls
        if ($channel === 'private-chatify' && $event === 'messaging') {
            \App\Events\MessageSent::dispatch($data);
            return true;
        }

        // Fallback to Pusher for other events (if needed)
